var mParticleAnalyticsKit = (function (exports) {
    ...
    */
    ...
    EventHandler.prototype.logEvent = function (event) {
        console.log(`here is the event name ${this.common.registrationEventName}`);
        if (event.EventName === this.common.registrationEventName) {
            mParticle.logEvent(
                '$User Authentication',
    ...
    var initialization = {
        ...
        */
        initForwarder: function (forwarderSettings, testMode, userAttributes, userIdentities, processEvent, eventQueue, isInitialized, common, appVersion, appName, customFlags, clientId) {
            ...
            if (!testMode) {
                common.registrationEventName = forwarderSettings.mPAnalyticsEventName;
            }
        }
    };
    ...
    */
    ...
    var SDKsettings = {
        ...
        "eventNameTokens": "[{&quot;jsmap&quot;:&quot;-675803158&quot;,&quot;map&quot;:&quot;-4100225352182696551&quot;,&quot;maptype&quot;:&quot;EventClass.Id&quot;,&quot;value&quot;:&quot;asdf&quot;},{&quot;jsmap&quot;:&quot;385820180&quot;,&quot;map&quot;:&quot;8137667737070804829&quot;,&quot;maptype&quot;:&quot;EventClass.Id&quot;,&quot;value&quot;:&quot;qwer&quot;}]",
        "mPAnalyticsEventName": "Registration Submit",
        "PriorityValue": 0
